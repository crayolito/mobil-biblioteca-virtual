...
class ContenedorNoSe2 extends StatefulWidget {
  const ContenedorNoSe2({
    super.key,
  });

  @override
  State<ContenedorNoSe2> createState() => _ContenedorNoSe2State();
}

class _ContenedorNoSe2State extends State<ContenedorNoSe2> {
